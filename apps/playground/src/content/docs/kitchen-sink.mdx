...
import { Badge, Card, CardGrid, FileTree, Icon, LinkButton, LinkCard, Tabs, TabItem, Steps, Aside } from '@astrojs/starlight/components';
...
### File title + line highlight

```ts title="src/plugin/index.ts" {3,7-9}
import type { StarlightPlugin } from '@astrojs/starlight/types';
...
```json title="scripts/ts-autodoc.json"
{
...
### Feature <Badge text="Beta" variant="caution" /> <Badge text="v0.4+" variant="tip" />
...
<Icon name="rocket" /> <Icon name="star" /> <Icon name="approve-check" /> <Icon name="warning" /> <Icon name="information" /> <Icon name="github" /> <Icon name="external" />

Icon sizes:

<Icon name="rocket" size="1rem" /> <Icon name="rocket" size="1.5rem" /> <Icon name="rocket" size="2rem" />

## LinkButton

<LinkButton href="/quickstart/">Get started</LinkButton>
<LinkButton href="/quickstart/" variant="secondary">Read the docs</LinkButton>
<LinkButton href="https://github.com/Abstract-Data/abstract-data-doc-theme" variant="minimal" icon="github" target="_blank">View on GitHub</LinkButton>
